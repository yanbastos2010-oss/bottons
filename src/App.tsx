    ...
    <section id="ofertas" className="py-20 px-4 bg-white">
      ...
      {showUpsell && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
          <div id="upsell-modal" className="bg-white rounded-2xl w-full max-w-md p-6 relative animate-[popupIn_0.3s_ease_forwards]">
            <button id="upsell-close" onClick={() => setShowUpsell(false)} aria-label="Fechar" className="absolute top-4 right-4 text-gray-500 hover:text-gray-800 text-xl font-bold">✕</button>
            <p className="text-center font-black text-2xl text-black mb-2 uppercase">Espere! Oferta Especial 🔥</p>
            <p className="text-center font-bold text-gray-800 text-sm mb-4" id="upsell-subtitle">Leve o PLANO COMPLETO com desconto exclusivo!</p>
            <p className="text-center text-gray-400 line-through text-sm mb-1" id="upsell-old-price">De R$27,00</p>
            <p className="text-center text-5xl font-black text-green-600 mb-6 leading-none">R$17</p>
            <ul id="upsell-list" className="space-y-3 mb-6 text-left w-fit mx-auto">
              <li className="flex items-start gap-2 text-sm text-gray-800 border-b border-gray-100 pb-2">
            ...
            <a href="https://ggcheckout.app/checkout/v5/NbBS5H7FyEpG2X7D9t2v" className="block w-full bg-green-600 hover:bg-green-700 text-white font-black text-lg text-center py-4 rounded-lg mb-3 shadow-[0_4px_15px_rgba(22,163,74,0.4)] transition-colors">QUERO O COMPLETO POR R$17</a>
            <a href="https://ggcheckout.app/checkout/v5/hP4KHlfuZ0PReMGM5Ets" className="block w-full text-center text-gray-500 hover:text-gray-800 text-sm font-bold underline py-2">Continuar com o Básico</a>
          </div>
        </div>
      )}
    </section>
